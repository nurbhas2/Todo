...
define('text!app.html', ['module'], function(module) { module.exports = "<template>\n    <router-view>810 Web Dev - Nur</router-view>\n</template>"; });
